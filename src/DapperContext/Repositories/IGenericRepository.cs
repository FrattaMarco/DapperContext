...
namespace DapperContext.Repositories
{
    public interface IGenericRepository
    {
        ...
        Task<IEnumerable<T>> GetAsyncWithQuery<T>(string query, object parameters = null!) where T : class;
        Task<bool> ExecuteAsyncWithQuery(string query, object parameters = null!);
        Task<T> UpdateAsyncWithQuery<T>(string query, object parameters = null!) where T : class;
    }
}
