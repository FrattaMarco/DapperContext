...
namespace DapperContext.Repositories
{
    public interface IGenericRepository
    {
        ...
        Task<IEnumerable<T>> GetAsyncWithQuery<T>(string query) where T : class;
        Task<bool> ExecuteAsyncWithQuery(string query);
        Task<T> UpdateAsyncWithQuery<T>(string query) where T : class;
    }
}
